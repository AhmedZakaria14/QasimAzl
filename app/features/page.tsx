      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="dark-surface flex flex-col lg:flex-row items-stretch gap-0 rounded-3xl overflow-hidden shadow-2xl">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={item} className="flex items-center gap-3">
                  <div className="w-7 h-7 rounded-full bg-white/15 border border-white/20 flex items-center justify-center shrink-0"><CheckCircle className="w-4 h-4 text-[#d2e8b3]" /></div>
          ...
          <div className="lg:w-1/2 min-h-[500px] relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#201044]/35 via-transparent to-transparent lg:bg-gradient-to-r" />
          </div>
        </div>
      </div>
    </div>
